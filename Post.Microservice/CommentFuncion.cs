...
{
    public class CommentFuncion
    {
        private readonly ILogger<CommentFuncion> _logger;

        private readonly ICommentGrpcService _commentService;

        public CommentFuncion(ILogger<CommentFuncion> log, ICommentGrpcService commentGrpcService)
        {
            _logger = log;
